...
<body>
    ...
    <div class="center">
        @foreach( $DataTrait->getAllPost() as $post)
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <div class="media mb-3">
                        ...
                        @if(auth()->guard('web')->user()->id == $post->records_id )
                        <a href="{{ route('post-delete',['id'=>$post->id])}}" onclick="return confirm('Are you sure, you want to delete this post?')" style="float: right;">
